...
<template>
  <div class="relative min-h-screen bg-darker">
    ...
    <div class="login-container flex-1 flex items-center justify-center p-8">
      <div
        class="login-card bg-gradient-to-br from-dark/80 to-darker/95 rounded-xl shadow-lg border border-primary/20 w-full max-w-450 p-12 text-center backdrop-blur-sm">
        ...
        <p class="create-account mt-8 text-blue-200">
          ...
          <a href="register.html"
             class="font-semibold
            text-primary no-underline transition-colors duration-300 hover:text-primary-dark">Sign up</a>
        </p>
