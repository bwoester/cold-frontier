...
.corner-accent {
  ...
  width: 30px;
  height: 30px;
  border: 2px solid rgba(64, 218, 255, 0.4);
  z-index: 2;
  pointer-events: none;
  /*box-shadow: 0 0 8px rgba(64, 218, 255, 0.2);*/
}
...
.bracket {
  ...
  padding: 0 4px;
  font-weight: bold;
  text-shadow: 0 0 8px rgba(64, 218, 255, 0.5);
}
...
.indicator-light.active {
  ...
  box-shadow: 0 0 8px #4cc2ff, inset 0 0 3px rgba(255, 255, 255, 0.5);
}
...
.planet-core {
  ...
  border-radius: 50%;
  box-shadow: 0 0 10px rgba(64, 218, 255, 0.6);
}
...
.planet-dropdown {
  ...
  border: 1px solid rgba(64, 218, 255, 0.35);
  border-radius: 8px;
  overflow: hidden;
  z-index: 20;
...
.nav-link {
  ...
  background-color: rgba(30, 60, 100, 0.1);
